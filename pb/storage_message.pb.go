...
type Storage struct {
	Driver               Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=lokialice.pc_book.Storage_Driver" json:"driver,omitempty"`
...
func init() {
	proto.RegisterEnum("lokialice.pc_book.Storage_Driver", Storage_Driver_name, Storage_Driver_value)
	proto.RegisterType((*Storage)(nil), "lokialice.pc_book.Storage")
}
...
var fileDescriptor_170f09d838bd8a04 = []byte{
	...
	0xc9, 0x17, 0x12, 0xcc, 0xc9, 0xcf, 0xce, 0x4c, 0xcc, 0xc9, 0x4c, 0x4e, 0xd5, 0x2b, 0x48, 0x8e,
	0x4f, 0xca, 0xcf, 0xcf, 0x96, 0x12, 0xc9, 0x4d, 0xcd, 0xcd, 0x2f, 0xaa, 0x44, 0x55, 0xa8, 0xb4,
	...
	0x5d, 0xab, 0x05, 0x89, 0xf1, 0x00, 0x00, 0x00,
}
