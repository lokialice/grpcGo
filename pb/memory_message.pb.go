...
type Memory struct {
	...
	Unit                 Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=lokialice.pc_book.Memory_Unit" json:"unit,omitempty"`
...
func init() {
	proto.RegisterEnum("lokialice.pc_book.Memory_Unit", Memory_Unit_name, Memory_Unit_value)
	proto.RegisterType((*Memory)(nil), "lokialice.pc_book.Memory")
}
...
var fileDescriptor_c0c7f919ccc765da = []byte{
	...
	0x17, 0x12, 0xcc, 0xc9, 0xcf, 0xce, 0x4c, 0xcc, 0xc9, 0x4c, 0x4e, 0xd5, 0x2b, 0x48, 0x8e, 0x4f,
	...
	0x00, 0xff, 0xff, 0x3e, 0xff, 0xb0, 0x85, 0xec, 0x00, 0x00, 0x00,
}
